...
En cambio por otro lado run(), es como si estuviéramos llamando una clase normal con su método 
implementado, por eso la salida se ve como los números se imprimen de forma lineal.
